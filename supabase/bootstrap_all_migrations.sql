-- ============================================================
-- wacrm: bootstrap completo del esquema (migraciones 001-037)
-- Generado automáticamente concatenando supabase/migrations/*.sql
-- en orden. Todas las migraciones son idempotentes, así que este
-- archivo se puede correr sobre una base nueva o re-correr sin
-- peligro. Uso: canalizarlo a psql contra la base 'postgres' de
-- un stack Supabase self-hosted (ver docs/ycloud.md).
-- ============================================================
...
-- ------------------------------------------------------------
-- BEGIN supabase/migrations/037_ycloud_provider.sql
-- ------------------------------------------------------------
-- ============================================================
...
-- END supabase/migrations/037_ycloud_provider.sql
